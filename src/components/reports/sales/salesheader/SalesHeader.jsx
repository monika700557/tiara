  ...
  return (
    <div className="flex justify-between items-center mb-6">
      <div>
        ...
        <p className="text-gray-600">Dashboard / Sales</p>
      </div>
      <div className="flex space-x-2">
          <button
           ...
           <button className="flex items-center justify-center p-2 bg-  text-white rounded hover: bg-[#7638ff] w-[2.5rem] h-[2.5rem]">
