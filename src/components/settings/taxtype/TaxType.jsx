    ...
    <div className="w-[95%] ml-[4rem] mt-[6rem] bg-white rounded-lg shadow">
      <div className="border-b border-gray p-4">
        <div className="flex flex-row justify-between">
          <h2 className="text-xl font-semibold mb-6">Tax Types</h2>
          <button className="w-[8rem] h-[3rem] text-center p-[10px] bg-transparent text-purple-500 border border-purple-500 rounded-lg">
            Add New Tax
          </button>
        </div>
